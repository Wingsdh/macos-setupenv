...
function MyCustomHighlights()
    hi semshiGlobal          ctermfg=214 guifg=#728aff
    hi semshiImported        ctermfg=214 guifg=#728aff
endfunction
...
vim.api.nvim_set_keymap("n", "c-t", "<C-\\><C-n>:FloatermNext<CR>", { silent = true, noremap = true, })
...
vim.api.nvim_set_keymap("n", "<c-t>", ":FloatermToggle<CR>", { silent = true, noremap = true, })
vim.api.nvim_set_keymap("t", "<c-t>", "<C-\\><C-n>:FloatermToggle<CR>", { silent = true, noremap = true, })
vim.api.nvim_set_keymap("t", "<m-q>", "<C-\\><C-n>", { silent = true, noremap = true, })

vim.api.nvim_command([[
filetype plugin indent on
syntax enable
autocmd Filetype python,go,yaml]])
...
vim.api.nvim_set_keymap("n", "<Leader>WQ", ":wa<CR>qa<CR>", { noremap = true, })
